...
"""
    ...
    MANDANENG_TXT = f"""<b>Helo {msg.from_user.first_name} I could not find the movie you asked for 🥴
...
If you do not receive the movie even after entering the correct name ...  @admin type movie name Inform the admin in this format .. We will upload within 24 hours 😇</b>""" 
    ...
    MANDANML_TXT = f"""<b>ഹലോ {msg.from_user.first_name} നിങ്ങൾ ആവശ്യപ്പെട്ട ഈ സിനിമ എനിക്ക് കണ്ടെത്താൻ കഴിഞ്ഞില്ല 🥴 ...
